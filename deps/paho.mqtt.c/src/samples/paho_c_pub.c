...
struct pubsub_opts opts =
{
	...
	MQTTVERSION_DEFAULT, NULL, "paho-c-pub", 0, 0, NULL, NULL, "150.158.83.55", "1883", NULL, 10, /* MQTT options */
...
int main(int argc, char** argv)
{
	...
	printf("url: %s\n", url);
	printf("MQTTAsync_createWithOptions: %d\n", rc);
	...
	printf("MQTTAsync_setCallbacks: %d\n", rc);
	if (rc != MQTTASYNC_SUCCESS)
	{
		if (!opts.quiet)
