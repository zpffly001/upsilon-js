...
# version: 1.3.12 quickjs-bindmqtt.o pubsub_opts.o libpaho-mqtt3c.so ---> quickjs-bindmqtt.so
gcc -shared -o quickjs-bindmqtt.so quickjs-bindmqtt.o pubsub_opts.o -lpaho-mqtt3c -L../lib/paho.mqtt.c/1.3.12
...
# version: 1.3.12 quickjs-gpio.o libpaho-mqtt3c.so ---> quickjs-bindmqtt.so
